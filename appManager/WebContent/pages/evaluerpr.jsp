        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li  class="active"><a href="evaluerpr.jsp">Professionnel responsable</a></li>
...
<div class="col-lg-12">
                    <h3 class="page-header"> Agir en professionnel responsable</h3>
                </div>
                <div class="col-sm-6">
                    <form role="form" >
                                <div class="form-group col-sm-6">
                                    ...
                                    <div><a href="afficherpr.jsp">Afficher</a></div>
          ...
          <form role="form">
            <div class="panel  panel-primary ">
                        <div class="panel-heading">
                            Agir avec probité professionnelle et honnêteté intellectuelle 
                        </div>
